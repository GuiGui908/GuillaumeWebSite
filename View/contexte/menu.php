<div id="header">
	<h3>Mis à jour le 30 Juillet 2015</h3>
</div>
...
<div id="menu">
	...
	<li><a href="<?php echo $GLOBALS['URL']; ?>Partage.php">Partage de Fichiers</a></li>
	<li><a href="<?php echo $GLOBALS['URL']; ?>Plan.php">Plan du Site</a></li>
	</ul>
</div>
